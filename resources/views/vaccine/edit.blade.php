       ...
       <form class="row g-3" method="post" action="{{route('vaccines.update',$vaccine)}}" enctype="multipart/form-data">
            ...
            <div class="col-12">
              ...
              <div class="col-12">
                ...
                <input type="text" class="form-control" id="inputPassword4" name="recommended_age"  value="{{old('recommended_age', $vaccine->recommended_age)}}" class="@error('recommended_age') is-invalid @enderror">
