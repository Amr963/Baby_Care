    ...
    <div class="form-container animated-card">
        ...
        <form method="POST" action="{{route('rightVaccine')}}">
            ...
            <div class="form-group">
                ...
                <select id="selection" name="select_month"
                    style="border: none; background-color: #f4ccd7; color: #914f66; padding: 15px; font-size: 18px; border-radius: 8px; transition: background-color 0.3s ease-in-out;">
